    ...
    public partial class SeederFix2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1000, "test@nursima.com", "Nursima Test", "123" });

            migrationBuilder.InsertData(
                table: "Notes",
                columns: new[] { "Id", "CreatedDate", "Description", "FileName", "FilePath", "IsDeleted", "Title", "UpdatedDate", "UserId" },
                values: new object[] { 1001, new DateTime(2026, 3, 19, 5, 0, 41, 477, DateTimeKind.Local).AddTicks(674), "Seeder verisi", null, null, false, "Mülakat Hazırlığı 📚", new DateTime(2026, 3, 19, 5, 0, 41, 477, DateTimeKind.Local).AddTicks(675), 1000 });
